    ...
    <section id="projects"
        ...
        <div className="max-w-5xl mx-auto px-4 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl border border-black/10 dark:border-white/10 hover:-translate-y-1 hover:border-blue-500/30
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors">🤖 Self analyzing Discord bot:</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-4 break-words">A Discord bot that fetches and analyzes personal TFT match data using Riot’s API.
                ...
                <h3 className="text-xl font-bold mb-2 group-hover:text-blue-400 transition-colors">🎮 2D shooting game:</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-4 break-words">A 2D top-down shooter game built with Python and Pygame.
