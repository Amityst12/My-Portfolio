...
export const LoadingScreen = ( {onComplete} ) => { //Make loading animation
    ...
    return(
     ...
     <div className="fixed inset-0 z-50 bg-gray-50 text-gray-900 dark:bg-black dark:text-gray-100 flex flex-col items-center justify-center">
        <div className="mb-4 text-[2.125rem] font-mono font-bold mx-auto">
            {text} <span className="animate-blink ml-1">| </span> 
        </div>

        <div className="w-[370px] h-[5px] bg-gray-300 dark:bg-gray-800 rounded relative overflow-hidden mx-auto">
